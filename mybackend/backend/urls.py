...
from api.views import UsersViewSet, GroupViewSet, ContractorViewSet, EmailsViewSet, Pedidos_pendentesViewSet, Pedidos_entreguesViewSet, PedidosViewSet, CargasInfoViewSet, StatBoxViewSet
