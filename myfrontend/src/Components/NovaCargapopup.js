...
const NovaCargapopup = () => {
    ...
    const handleCountryChange = (e) => {
        ...
        const countryorigin = countriesList.find((country) => country.iso2 === e.target.value);

        if (countryorigin) {

            setCountryid(countryorigin.iso2);
...
{/*                         <FormControl fullWidth>
                        ...
                        <InputLabel shrink placeholder="Selecione um pais">Selecione um país</InputLabel>
                                <select name="origin"
                                        ...
                                        onChange={(e) => {
                                        const countryorigin = countriesList[e.target.value]; //here you will get full country object.
                                        setCountryid(countryorigin.iso2);
                                        GetState(countryorigin.iso2).then((result) => {
                                            setStateList(result);
                                        });
